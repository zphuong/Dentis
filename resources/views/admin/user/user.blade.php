			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-6">
					...
					<div class="card card-primary">
						<!-- /.card-header -->
						<!-- form start -->
						<form action="{{URL::to('dashboard/user/add')}}" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input type="text" id="name" class="form-control" placeholder="Nhập tên quản trị viên" name="name">
									@error('name')
